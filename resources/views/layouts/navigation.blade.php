<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ml-8 md:flex">
                    ...
                    @if (auth()->user()->account_type != 'student')
                        <x-nav-link :href="route('exams.all')" :active="request()->routeIs('exams.*')" class="px-1 pt-1">
                            Exams
                        </x-nav-link>
                    @endif
            ...
            <div class="hidden md:flex md:items-center md:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent capitalize text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="pl-3">
                Dashboard
            ...
            @endif
            @if (auth()->user()->account_type != 'student')
                <x-responsive-nav-link :href="route('exams.all')" :active="request()->routeIs('exams.*')" class="pl-3">
                    Exams
                </x-responsive-nav-link>
            @endif
