                                    ...
                                    <template x-cloak x-for="dept in pagedDepts" :key="dept.id" >
                                        <tr class="bg-white border-b">
                                            ...
                                            <td class="px-6 py-4 flex justify-center items-center space-x-2">
                                                <div class="inline-flex justify-start items-center gap-1">
                                                    <button @click="" class=" flex-1 bg-green-500 focus:ring-green-700 inline-flex items-center px-4 py-2 border-transparent rounded-md font-semibold text-xs text-white tracking-widest focus:outline-none focus:ring-2 focus:ring-offset-2 transition ease-in-out duration-150">Edit</button>
